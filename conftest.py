...
from repodemo.histories_project.POM.Pages.Homepage import HomePage
from repodemo.histories_project.POM.Pages.Secondpage import SecondPage
...
def get_driver(request, get_browser):
    ...
    request.cls.secondpage = SecondPage(driver)
